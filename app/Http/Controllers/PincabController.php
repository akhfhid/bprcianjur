...
class PincabController extends Controller
{
    ...
    public function detailpegawai($id)
    {
        ...
        return view('pincab.detailpegawai', [
            'pegawai' => $pegawai,
            'cabang' => $cabang,
            'kelamin' => $kelamin,
            'jabatan' => $jabatan,
    ...
    public function setuju($id)
    {
        ...
        try {
            ...
            if ($pegawai && $approver && $ordercuti->status === 'DISETUJUI') {
                \App\Helpers\WhatsAppHelper::sendCutiApprovalFinalNotification($pegawai, $ordercuti, $approver);
            }
        } catch (\Exception $e) {
            \Log::error('Gagal Notif Approval Final Cuti', [
    ...
    public function print_pdf($id)
    {
        ...
        if (!$order) {
            return redirect()->route('pincab.peraturan')->with('status', 'Anda belum meminta dokumen ini');
        }
