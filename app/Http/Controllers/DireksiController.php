...
class DireksiController extends Controller
{
    ...
    public function indexpegawai(Request $request){
        ...
        return view ("direksi.pegawai",["pegawai"=>$data,"datapegawai"=>$datapegawai]);
    }
    ...
    public function detailpegawai($id){
        ...
        return view("direksi.detailpegawai",["pegawai"=>$pegawai,"cabang"=>$cabang,"kelamin"=>$kelamin,
    ...
    public function tolakcuti(){
     ...
     public function setujucuti(){
        ...
        return view('direksi.setujucuti',['orderc'=>$data]);
    ...
    public function cutiindex(Request $request){
        ...
        $ordercuti = \App\ordercuti::with('pegawai','cabang')
            ->where(function ($query) use ($jabpeg) {
                $query->where([
                    ['status',"LIKE","SUBMIT"],
        ...
        return view('direksi.cutiindex',['orderc'=>$data]);
    ...
    public function cutisetuju(Request $request){
        ...
        return view('direksi.cutisetuju',['orderc'=>$data]);
    }
    public function cutitolak (Request $request){
        ...
        return view('direksi.cutitolak',['orderc'=>$data]);
    }
     ...
     public function peraturan(Request $request){
        ...
        return view('direksi.peraturan',['peraturan'=>$peraturan]);
    }
    public function permohonandownload($id){
        ...
        return view('direksi.permohonandownload',['peraturan'=>$peraturan,'pegawai'=>$pegawai,'cabang'=>$cab]);
    }
    public function mintadownload(Request $request){
       ...
       $orderatur->save();
       return redirect()->route('direksi.peraturan')->with('status','Permintaan akan diproses');
   }
    ...
    public function statusatur(){
        ...
        return view ('direksi.statusatur',['orderatur' => $data]);
   ...
   public function showatur($id)
    {
        ...
        return view('direksi.showatur',['peraturan'=>$peraturan,'time'=>$time]);
    }
    public function show_pdf($id)
    {
        ...
        return view('direksi.show_pdf',['peraturan'=>$peraturan,'time'=>$time]);
    }
   public function rotasipegawai(Request $request){
    ...
    $idcabang = \Auth::user()->cabang;
      ...
      return view ('direksi.pegawairotasi',['pegawai'=>$data]);
    }
    public function mintarotasi($id){
      ...
      return view ('direksi.permohonanrotasi',['pegawai'=>$peg,'jabatan'=>$jabatan,'jabrot'=>$jabrot]);
    }
    public function inputrotasi(Request $request){
        ...
        return redirect()->route('direksi.pegawairotasi')->with('status','Permohonan Sudah Dinput');
    ...
    public function datarotasi(Request $request){
      //public function rotasiindex(Request $request){
        ...
        return view ('direksi.rotasiindex',['mutasi'=>$data]);
    }
    ...
    public function setujurotasi(Request $request){
      ...
      $cabang = \Auth::user()->cabang;
        ...
        return view ('direksi.setujurotasi',['mutasi'=>$data]);
    }
    public function tolakrotasi(Request $request){
      ...
      $cabang = \Auth::user()->cabang;
        ...
        return view ('direksi.tolakrotasi',['mutasi'=>$data]);
    }
    public function rotasisetuju($id){
        ...
        return redirect()->route('direksi.rotasiindex')->with('status','Data Rotasi Disetujui');
    ...
    public function rotasitolak($id){
        ...
        return redirect()->route('direksi.rotasiindex')->with('status','Data Rotasi Ditolak');
    ...
    public function mutasipangkat(Request $request)
      {
        ...
        return view ('direksi.mutasipangkat',['mutasipangkat'=>$data]);
    }
    public function setujupangkat($id){
        ...
        return redirect()->route('direksi.mutasipangkat')->with('status','Permohonan Mutasi Pangkat Berhasil Disetujui');
    }
    public function tolakpangkat($id){
        $mpangkat = \App\mutasipangkat::findorFail($id);
        $mpangkat->status = 'DITOLAK';
        $mpangkat->save();
        return redirect()->route('direksi.mutasipangkat')->with('status','Permohonan Mutasi Pangkat Ditolak');
    ...
    public function pangkatsetuju(Request $request){
        ...
        return view('direksi.pangkatsetuju',['mutasipangkat'=>$data]);
    ...
    public function pangkattolak(Request $request)
    {
        ...
        return view('direksi.pangkattolak',['mutasipangkat'=>$data]);
    }
}
