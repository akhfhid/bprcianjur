...
@section('title') Tambah Data Gaji & Tunjangan @endsection

@section('content')
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <h3 class="mb-3">Tambah Data Gaji & Tunjangan</h3>
    ...
    <form enctype="multipart/form-data" action="{{ route('gaji.store') }}" method="POST">
        @csrf
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="number" name="jabatan" id="jabatan" class="form-control" value="0">
                            </div>
                            <div class="col-md-6 form-group">
                                <label for="fungsi"><b>Tunjangan Fungsional</b></label>
                                <input type="number" name="fungsi" id="fungsi" class="form-control" value="0">
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-md-4 form-group">
                                <label for="bpjsks"><b>Tunjangan BPJS Kesehatan</b></label>
                                <input type="number" name="bpjsks" id="bpjsks" class="form-control" value="0">
                            </div>
                            <div class="col-md-4 form-group">
                                <label for="bpjstk"><b>Tunjangan BPJS Tenaga Kerja</b></label>
                                <input type="number" name="bpjstk" id="bpjstk" class="form-control" value="0">
                            </div>
                            <div class="col-md-4 form-group">
                                <label for="pph21"><b>Tunjangan PPH Pasal 21</b></label>
                                <input type="number" name="pph21" id="pph21" class="form-control" value="0">
                            </div>
                        </div>
                    </div>
                </div>
