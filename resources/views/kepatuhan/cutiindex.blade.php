...
<div class="row">
	<div class="col-md-12">
		<form action="{{route('kepatuhan.cutiindex')}}" >
			<div class="row">
				<div class="col-md-5">
...
<div class="row mb-3">
	<div class="col-md-12 text-right">
		<a href="{{route('kepatuhan.cutisetuju')}}" class="btn btn-primary">Disetujui</a>
		<a href="{{route('kepatuhan.cutitolak')}}" class="btn btn-primary">Ditolak</a>
	</div>
</div>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<form method="POST" class="d-inline" onsubmit="return confirm('Tolak Permohonan Cuti')" action="{{route('kepatuhan.tolak',[$order['id']])}}">
							@csrf
