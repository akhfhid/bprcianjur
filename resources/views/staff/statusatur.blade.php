...
<div class="row">
	...
	<div class="col-md-12 text-right">
		<a href="{{route('staff.peraturan')}}" class="btn btn-primary">Kembali</a>
	</div>
</div>
			...
			<tbody>
				...
				<tr>
					...
					<td>@if($atur['status'] =="SUBMIT")
						...
						@endif</td>
					<td>
						<a href="{{route('staff.showatur',$atur['idatur'])}}" class="btn btn-primary">Detail</a>
						@if($atur['status']=="SETUJU")
						<a href="{{route('staff.show_pdf',$peraturan->id)}}" class="btn btn-primary" target="_blank">Print</a>
						@endif
					</td>
				</tr>
			</tbody>
