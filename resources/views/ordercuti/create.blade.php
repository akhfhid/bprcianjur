...
<div class="col-md-8">
<h3 align="center">Form Permohonan Cuti Tahunan Pegawai</h3>
<hr class="my-3">
@if(session('status'))
...
@endif
<form action="{{route('ordercuti.store')}}" method="POST" enctype="multipart/form-data" class="shadow-sm p-3 bg-white">
			@csrf
