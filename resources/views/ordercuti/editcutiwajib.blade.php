...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <h3 align="center">Form Edit Cuti Wajib Pegawai</h3>
            <hr class="my-3">
            @if(session('status'))
            ...
            @endif
            <form action="{{route('ordercuti.update',[$ordercuti->id])}}" enctype="multipart/form-data" method="POST" class="shadow-sm p-3 bg-white">
                @csrf
