...
<div class="row">
	<div class="col-md-12">
		<form action="{{route('ordercuti.index')}}" >
			<div class="row">
				<div class="col-md-5">
...
<div class="row mb-3">
	<div class="col-md-12 text-right">
		<a href="{{route('ordercuti.create')}}" class="btn btn-primary">Permohonan Cuti Tahunan</a>
        <a href="{{route('ordercuti.cutiwajib')}}" class="btn btn-primary">Permohonan Cuti Wajib</a>
        <a href="{{route('ordercuti.cutilainnya')}}" class="btn btn-primary">Permohonan Cuti Lainnya</a>
