            ...
            <div class="card-body">
                ...
                <table border="0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="height: 10px; width: 200px;"><b>Nama <b></b></td>
                            <td>:</td>
                            <td>{{ $pegawai->name }}</td>
                        </tr>
                        <tr>
                            <td style="height: 10px;"><b>NIK Pegawai</b></td>
                            <td>:</td>
                            <td>{{ $pegawai->nikpegawai }}</td>
                        </tr>
                        <tr>
                            <td style="height: 10px;"><b>NIK Kependudukan</b></td>
                            <td>:</td>
                            <td>{{ $pegawai->nikpenduduk }}</td>
                        </tr>
                        <tr>
                            <td style="height: 10px;"><b>Tempat, Tanggal Lahir <b></td>
                            <td>:</td>
                            <td>{{ $pegawai->templahir }},{{ $pegawai->tgllahir }}</td>
                        </tr>
                        <tr>
                            <td style="height: 10px;"><b>Umur<b> </td>
                            <td>:</td>
                            <td>{{ $umur }}</td>
                        </tr>
                        <tr>
                            <td style="height: 10px;"><b>Agama <b></td>
                            <td>:</td>
                            <td>{{ $agama->name }}</td>
                        </tr>
                        <tr>
                            <td style="height: 10px;"><b>Golongan Darah</b></td>
                            <td>:</td>
                            <td>{{ $pegawai->goldar }}</td>
                        </tr>
                        <tr>
                            <td style="height: 10px;"><b>Status Perkawinan<b></td>
                            <td>:</td>
                            <td>{{ $kawin->name }}</td>
                        </tr>
                        <tr>
                            <td style="height: 10px;"><b>NPWP<b></td>
                            <td>:</td>
                            <td>{{ $pegawai->npwp }}</td>
                        <tr>
                        <tr>
                            <td style="height: 10px;"><b>No. HP<b></td>
                            <td>:</td>
                            <td>{{ $pegawai->nohp }}</td>
                        <tr>
                        <tr>
                            <td style="height: 10px;"><b>Email<b></td>
                            <td>:</td>
                            <td>{{ $pegawai->email }}</td>
                        <tr>
                            <td style="height: 10px;"><b>Alamat <b></td>
                            <td>:</td>
                            <td>{{ $pegawai->alamat }}</td>
                        </tr>
                        <tr>
                            <td style="height: 10px;"><b>Pendidikan Terakhir<b></td>
                            <td>:</td>
                            <td>{{ $pendidikan->name }}</td>
                        </tr>
                        <tr>
                            <td style="height: 10px;"><b>Status Kepegawaian<b></td>
                            <td>:</td>
                            <td>{{ $spegawai->name }}</td>
                        </tr>
                        <tr>
                            <td style="height: 10px;"><b>TMT</b></td>
                            <td>:</td>
                            <td>{{ $pegawai->tglmasuk }}</td>
                        </tr>
                        <tr>
                            <td style="height: 10px;"><b>Masa Kerja<b></td>
                            <td>:</td>
                            <td>{{ $masakerja }}</td>
                        </tr>
                        <tr>
                            <td style="height: 10px;"><b>Sisa Masa Kerja<b></td>
                            <td>:</td>
                            <td>{{ $smkerja }}</td>
                        </tr>
                        <tr>
                            <td style="height: 10px;"><b>Tanggal Pensiun</b></td>
                            <td>:</td>
                            <td>{{ $ppensiun }}</td>
                        </tr>
                        <tr>
                            @if ($pegawai->spegawai == 'Kontrak')
                                <td style="height: 10px;"><b>Pangkat<b></td>
                                <td>:</td>
                                <td>-</td>
                            @else
                                <td style="height: 10px;"><b>Pangkat<b></td>
                                <td>:</td>
                                <td>{{ $pangkat->name }} / {{ $pegawai->mkpang }} Tahun</td>
                            @endif

                        </tr>
                        <tr>
                            <td style="height: 10px;"><b>Jabatan</b></td>
                            <td>:</td>
                            <td>{{ $jabatan->name }}</td>
                        </tr>
                        <tr>
                            <td style="height: 10px;"><b>Kantor</b></td>
                            <td>:</td>
                            <td>{{ $cabang->name }}</td>
                        </tr>
                ...
                <div class="row mb-3">
                    <div class="col-md-12 text-right">
                        <a href="{{ route('keluarga.list', $pegawai->id) }}" class="btn btn-info btn-sm">Manage Data
                            Keluarga </a><br>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-12 text-right">
                        <a href="{{ route('riwayatpendi.list', $pegawai->id) }}" class="btn btn-info btn-sm">Manage Data
                            Pendidikan </a><br>
                    </div>
                </div>
                <table class="table table-bordered table-stripped">
                ...
                <div class="row mb-3">
                    <div class="col-md-12 text-right">
                        <a href="{{ route('riwayatangkat.list', $pegawai->id) }}" class="btn btn-info btn-sm">Manage Riwayat
                            Status </a><br>
                    </div>
                </div>
                <table class="table table-bordered table-stripped">
                ...
                <div class="row mb-3">
                    <div class="col-md-12 text-right">
                        <a href="{{ route('riwayatkerja.list', $pegawai->id) }}" class="btn btn-info btn-sm">Manage Data
                            Karier </a><br>
                    </div>
                </div>
                <table class="table table-bordered table-stripped">
                ...
                <div class="row mb-3">
                    <div class="col-md-12 text-right">
                        <a href="{{ route('riwayatsanksi.list', $pegawai->id) }}" class="btn btn-info btn-sm">Manage Data
                            Sanksi </a><br>
                    </div>
                </div>
                <table class="table table-bordered table-stripped">
                ...
                <div class="row mb-3">
                    <div class="col-md-12 text-right">
                        <a href="{{ route('pegawai.editberkala', $pegawai->id) }}" class="btn btn-info btn-sm">Manage Data
                            Jadwal Kenaikan Gaji </a><br>
                    </div>
                </div>
                <table class="table table-bordered table-stripped">
                    <thead>
                ...
                <div class="row mb-3">
                    <div class="col-md-12 text-right">
                        <a href="{{ route('pelatihan.list', $pegawai->id) }}" class="btn btn-info btn-sm">Manage Data
                            Pelatihan </a><br>
                    </div>
                </div>
                <table class="table table-bordered table-stripped">
