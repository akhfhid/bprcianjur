...
<div class="row mb-3">
	<div class="col-md-12 text-right">
<a href="{{route('riwayatangkat.list',$pegawai->id)}}" class="btn btn-info btn-sm">Manage Riwayat Status </a><br>
</div>
</div>
<table class="table table-bordered table-stripped">
		<thead>
...
<table class="table table-bordered table-stripped">
    ...
    <div class="row mb-3">
        <div class="col-md-12 text-right">
            <a href="{{route('riwayatsanksi.list',$pegawai->id)}}" class="btn btn-info btn-sm">Manage Data Sanksi </a><br>
        </div>
    </div>
    <table class="table table-bordered table-stripped">
        <thead>
...
<hr class="my-3">
    <div class="row mb-3">
        <div class="col-md-12 text-right">
            <a href="{{route('pegawai.editberkala',$pegawai->id)}}" class="btn btn-info btn-sm">Manage Data Jadwal Kenaikan Gaji </a><br>
        </div>
    </div>
    <table class="table table-bordered table-stripped">
        <thead>
		...
		<div class="row mb-3">
        <div class="col-md-12 text-right">
            <a href="{{route('gaji.list',$pegawai->id)}}" class="btn btn-info btn-sm">Manage Data Gaji </a><br>
        </div>
    </div>
<table class="table table-bordered table-stripped">
			<thead>
