...
<div class="row">
	...
	<div class="col-md-12 text-right">
		<a href="{{route('kadiv.peraturan')}}" class="btn btn-primary">Kembali</a>
	</div>
</div>
				...
				<tr>
					...
					<td>
						@if($atur['status']=="SETUJU" )
							@if($atur['print']=="f")
						<a href="{{route('kadiv.show_pdf',$atur['idatur'])}}" class="btn btn-primary" target="_blank" id="print">Print</a>
							@elseif($atur['print']=="t")
							<a href="{{route('kadiv.showatur',$atur['idatur'])}}" class="btn btn-primary">Detail</a>
							@endif
						@endif
					</td>
				</tr>
