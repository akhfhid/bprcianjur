...
<div class="row">
	<div class="col-md-6">
		<form action="{{route('kadiv.indexpegawai')}}">
		...
		<table class="table table-bordered table-stripped">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="{{route('kadiv.detailpegawai',[$pegawais['id']])}}" class="btn btn-icon btn-warning" title="Detail Data Pegawai"><i class="far fa-user"></i></a>
					</td>
				</tr>
				@endforeach
			</tbody>
