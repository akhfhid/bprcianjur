...
<div class="row">
	...
	<div class="col-md-6">
		<ul class="nav nav-pills card-header-pills">
			<li class="nav-item">
				<a class="nav-link" href="{{route('kadiv.peraturan')}}">Published</a>
			</li>
			<li class="nav item">
				<a class="nav-link active" href="{{route('kadiv.trash')}}">Trash</a>
			</li>
		</ul>
	</div>
</div>
		...
		<table class="table table-bordered table-stripped">
			...
			<tbody>
				...
				<tr>
					...
					<td>{{$atur->uraian}}</td>
					<td>
						<a href="{{route('kadiv.showtrash',[$atur->id])}}" class="btn btn-primary btn-sm">Detail</a>
					</td>
				</tr>
			</tbody>
			@endforeach
