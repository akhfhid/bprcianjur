...
<div class="row">
	<div class="col-md-6">
		<form action="{{route('supervisor.indexpegawai')}}">
		...
		<table class="table table-bordered table-stripped">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="{{route('supervisor.editpegawai',[$pegawais['id']])}}" class="btn btn-icon btn-primary" title="Edit Data Pegawai"><i class="far fa-edit"></i> </a>
						<a href="{{route('supervisor.detailpegawai',[$pegawais['id']])}}" class="btn btn-icon btn-warning" title="Detail Data Pegawai"><i class="far fa-user"></i></a>
					</td>
				</tr>
				@endforeach
			</tbody>
