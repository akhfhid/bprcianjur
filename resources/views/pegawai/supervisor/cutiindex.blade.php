...
<div class="row">
	<div class="col-md-12">
		<form action="{{route('supervisor.cutiindex')}}" >
			<div class="row">
				<div class="col-md-5">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<form method="POST" class="d-inline" onsubmit="return confirm('Setujui Permohonan Cuti')" action="{{route('supervisor.setuju',[$order['id']])}}">
							@csrf
							<input type="submit" value="Setuju" class="btn btn-success btn-sm">
						</form>
						<form method="POST" class="d-inline" onsubmit="return confirm('Tolak Permohonan Cuti')" action="{{route('supervisor.tolak',[$order['id']])}}">
							@csrf
