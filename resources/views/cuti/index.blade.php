...
<style>
    ...
    .badge-count { background: #e0e7ff; color: #4338ca; font-weight: bold; padding: 5px 12px; border-radius: 50px; font-size: 0.85rem; }
</style>
        ...
        <form method="GET">
            <div class="row align-items-end">
                <div class="col-md-5 mb-2 mb-md-0">
                    ...
                    <input type="text" name="q" value="{{ request('q') }}" class="form-control form-control-custom"
                    ...
                    @forelse ($cutis as $pegawaiId => $items)
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                ...
                                <small class="text-muted text-uppercase" style="font-size: 0.7rem;">ID: {{ $pegawai->id ?? 'N/A' }}</small>
                            </td>
                            ...
                            <td class="text-center">
                                ...
                                @else
                                    <span class="text-muted small italic">Pegawai terhapus</span>
                                @endif
                            </td>
                        </tr>
                    @empty
