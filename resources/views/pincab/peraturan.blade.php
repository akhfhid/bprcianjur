	...
	<div class="container-fluid py-4">
		...
		<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
			...
			<div class="d-flex gap-2">
				<a href="{{ route('pincab.status') }}" class="btn btn-primary-custom btn-modern">
					<i class="fas fa-clipboard-list mr-2"></i> Status Permintaan Data
				</a>
			</div>
		</div>
				...
				<table class="table mb-0" id="atur">
					<thead>
						<tr>
							...
							<th class="text-center">Tanggal Laku</th>
