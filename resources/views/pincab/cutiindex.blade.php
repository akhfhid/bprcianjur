...
<div class="row">
	<div class="col-md-12">
		<form action="{{route('pincab.cutiindex')}}" >
			<div class="row">
				<div class="col-md-5">
...
<div class="row mb-3">
	<div class="col-md-12 text-right">
		<a href="{{route('pincab.cutisetuju')}}" class="btn btn-primary">Disetujui</a>
		<a href="{{route('pincab.cutitolak')}}" class="btn btn-primary">Ditolak</a>
	</div>
</div>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<form method="POST" class="d-inline" onsubmit="return confirm('Setujui Permohonan Cuti')" action="{{route('pincab.setuju',[$order['id']])}}">
							@csrf
							<input type="submit" value="Setuju" class="btn btn-success btn-sm">
						</form>
						<form method="POST" class="d-inline" onsubmit="return confirm('Tolak Permohonan Cuti')" action="{{route('pincab.tolak',[$order['id']])}}">
							@csrf
