...
<div class="row">
	<div class="col-md-6">
		<form action="{{route('pincab.indexpegawai')}}">
		...
		<table class="table table-bordered table-stripped">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="{{route('pincab.detailpegawai',[$pegawais['id']])}}" class="btn btn-icon btn-primary" title="Detail Data Pegawai">Detail<i class="far fa-user"></i></a>
					</td>
				</tr>
				@endforeach
			</tbody>
