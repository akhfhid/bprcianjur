...
<div class="row">
	<div class="col-md-12">
		<form action="{{route('kadiv.cutiindex')}}" >
			<div class="row">
				<div class="col-md-5">
...
<div class="row mb-3">
	<div class="col-md-12 text-right">
		<a href="{{route('kadiv.cutisetuju')}}" class="btn btn-primary">Disetujui</a>
		<a href="{{route('kadiv.cutitolak')}}" class="btn btn-primary">Ditolak</a>
	</div>
</div>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<form method="POST" class="d-inline" onsubmit="return confirm('Proses Permohonan Cuti')" action="{{route('kadiv.setuju',[$order['id']])}}">
							@csrf
