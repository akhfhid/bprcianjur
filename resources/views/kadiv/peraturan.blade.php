...
<div class="row">
	<div class="col-md-6">
		<form action="{{route('kadiv.peraturan')}}">
		...
		<ul class="nav nav-pills card-header-pills">
			<li class="nav-item">
				<a class="nav-link active" href="{{route('kadiv.peraturan')}}">Published</a>
			</li>
			<li class="nav item">
...
<div class="row">
	...
	<div class="col-md-12 text-right">
		<a href="{{route('kadiv.status')}}" class="btn btn-primary">Status Permintaan Data</a>
