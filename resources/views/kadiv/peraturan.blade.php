	...
	<div class="container-fluid py-4">
		...
		<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
			<div>
				...
				<p class="page-subtitle mb-0">Data peraturan</p>
			</div>

			<div class="d-flex gap-2">
				<a href="{{ route('kadiv.status') }}" class="btn btn-status btn-modern">
					<i class="fas fa-clipboard-list mr-2"></i> Status Permintaan
				</a>
